...
open class BalloonMarker: MarkerImage
{
    ...
    {
        let currency = isStocks ? "$" : (Utilities.getSymbol(for: UserDefaults.standard.string(forKey: K.defaultFiat) ?? "USD"))
        setLabel(Utilities.formatPriceLabel(String(entry.y), with: currency))
    }
